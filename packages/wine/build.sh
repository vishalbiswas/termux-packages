...
TERMUX_PKG_EXTRA_CONFIGURE_ARGS="--disable-tests --with-wine-tools=${TERMUX_PKG_HOSTBUILD_DIR} --without-x --without-freetype --without-pcap ac_cv_header_resolv_h=no ac_cv_cflags__Wl__no_pie=no"
